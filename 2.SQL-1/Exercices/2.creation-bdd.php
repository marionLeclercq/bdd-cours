...
<head>
  ...
  <title>Creation d'une base de données avec SQL</title>
...
<body class="markdown-body">
  <div class="container">
    <h1>Creation d'une base de données avec SQL</h1>
    <b>Exercice: </b>
    <ul>
      <li>
        1. Ecrivez une commande SQL qui sert à créer une base de données appelée login_db.
      </li>
      <li>
        2. Testez la commande en utilisant l'editeur de code SQL de phpMyAdmin.
      </li>
    </ul>
    <br>
